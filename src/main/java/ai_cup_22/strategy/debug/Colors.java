...
public class Colors {
    public static Color RED_TRANSPARENT = new Color(1f, 0f, 0f, 0.3f);
    public static Color GREEN_TRANSPARENT = new Color(0f, 1f, 0f, 0.3f);
    public static Color GRAY_TRANSPARENT = new Color(0.5f, 0.5f, 0.5f, 0.6f);
    ...
    public static Color ORANGE_TRANSPARENT = new Color(1f, 0.7f, 0f, 0.3f);
